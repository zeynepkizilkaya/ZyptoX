      ...
      <div className="max-w-[1440px] h-full mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-10 h-7 text-xs font-bold rounded-md border border-hairline-light dark:border-hairline-dark hover:bg-surface-strong-light dark:hover:bg-surface-elevated-dark text-muted dark:text-muted-strong transition-colors duration-150 uppercase"
