...
import type { Asset, Transaction } from '../services/api';
    ...
    <div className="max-w-6xl mx-auto py-8 px-4 flex flex-col gap-6 animate-fade-in font-sans">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-1 text-left">
          <span className="text-[9px] text-muted font-bold uppercase tracking-wider font-sans">{t('dailyChange')}</span>
        ...
        <div className="p-4 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-1 text-left">
          <span className="text-[9px] text-muted font-bold uppercase tracking-wider font-sans">{t('allTimeRoi')}</span>
        ...
        <div className="p-4 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-1 text-left">
          <span className="text-[9px] text-muted font-bold uppercase tracking-wider font-sans">{t('bestPerformer')}</span>
        ...
        <div className="p-4 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-1 text-left">
          <span className="text-[9px] text-muted font-bold uppercase tracking-wider font-sans">{t('worstPerformer')}</span>
          <div className="flex items-center gap-1.5 mt-0.5">
        ...
        <div className="flex flex-col gap-6 min-w-0">
          <div className="p-6 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div className="flex flex-col">
                <span className="text-[10px] text-muted font-bold uppercase tracking-wider">{t('estimatedNetWorth')}</span>
                ...
                <span className="text-[10px] text-muted mt-1 font-semibold flex items-center gap-1.5 flex-wrap">
                  <span>{t('cash')}:</span> <span className="font-extrabold text-ink dark:text-on-dark font-mono">${(user?.balance || 0).toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
                  <span className="opacity-40">•</span>
                  <span>{t('crypto')}:</span> <span className="font-extrabold text-accent font-mono">${cryptoTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </span>
              </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <h3 className="text-lg font-bold">{t('myCryptoAssets')}</h3>
        ...
        <div className="flex flex-col gap-6">
          <div className="p-5 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl shadow-sm flex flex-col gap-4 animate-fade-in">
            ...
            <div className="bg-slate-50 dark:bg-canvas-dark border border-hairline-light/60 dark:border-hairline-dark/25 rounded-xl p-3.5 flex flex-col text-left">
              <span className="text-[9px] text-muted font-bold uppercase tracking-wider font-sans">{t('usdCashBalance')}</span>
      ...
      {showDepositModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
          <div className="bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-2xl p-6 w-full max-w-sm shadow-2xl flex flex-col gap-4 animate-scale-up font-sans text-left">
            <div className="flex justify-between items-center">
              <h3 className="text-base font-black text-ink dark:text-on-dark">{t('depositSimulatedCash')}</h3>
              <button
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold text-muted">{t('amountToDeposit')}</label>
              <div className="relative">
