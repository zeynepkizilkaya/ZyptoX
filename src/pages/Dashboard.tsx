...
import type { MarketPrice, Asset } from '../services/mockApi';
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const loadPortfolio = async () => {
        try {
          const portfolioData = await mockApi.getPortfolio();
        ...
        <div className="max-w-[1280px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-ink dark:text-on-dark leading-tight">
              TRADE CRYPTO WITH CONFIDENCE ON ZYPTOX
            </h1>
            <p className="text-base md:text-lg text-muted max-w-lg">
              Trade crypto assets with the lowest commissions, fastest execution speeds, and smart analytics powered by Gemini.
            </p>
          ...
          <div className="hidden lg:flex flex-col gap-4 w-[440px] select-none">
            <div className="flex justify-between items-center pb-2 border-b border-hairline-light dark:border-hairline-dark">
              <div className="flex flex-col text-left">
                <span className="font-extrabold text-base tracking-tight text-ink dark:text-on-dark">Live Market</span>
                <span className="text-[10px] text-muted font-normal mt-0.5 leading-none">Auto-refreshing cache prices</span>
              </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-hairline-light dark:border-hairline-dark text-muted text-xs font-semibold">
                  ...
                  <th className="py-3 px-4">24h Sparkline (Trend)</th>
        ...
        <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-lg flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <h3 className="font-bold text-sm">Live Feed Price Ticker</h3>
              <p className="text-xs text-muted">Track fluctuations for BTC, ETH, SOL and major digital assets every 15s.</p>
            </div>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-lg flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-primary">RISK-FREE</span>
              <h3 className="font-bold text-sm">Simulated Balances</h3>
              <p className="text-xs text-muted">Test trading methods with a free mock balance allocated upon registration.</p>
            </div>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-surface-card-dark border border-hairline-light dark:border-hairline-dark rounded-lg flex items-start gap-4">
            ...
            <div className="flex flex-col gap-1">
              <span className="text-xs font-bold text-primary">INTELLIGENT</span>
              <h3 className="font-bold text-sm">Gemini AI Assistant</h3>
              <p className="text-xs text-muted">Ask for technical analysis and dynamic wallet breakdowns instantly.</p>
            </div>
          </div>
